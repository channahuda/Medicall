              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      const Spacer(),
                      VitalStats(image: 'Assets/blood.png',heading:  'Blood Pressure',c: bp,validkey:formkey),

                      const Spacer(),
                      VitalStats(image: 'Assets/oxygen.png',heading:  'Oxygen Level',c: oxygen,validkey:formkey),

                      const Spacer(),
                      VitalStats(image: 'Assets/heart.png',heading:  'Heart Rate',c: rate,validkey: formkey),
                      const Spacer(),
                    ],
                  ),
                  //PATIENT SYMPTOMS
